<template>
    <div class="bg-fixed h-[100vh] bg-no-repeat bg-cover bg-center " style="background-image: url('/src/images/v1_gif.gif')">
        <div class="bg-gray-800/50 h-[100%]">
            <div class="container mx-auto px-4">
                <div class="text-white pt-[25vh]">
                    <h1 class="text-4xl font-bold mb-5">বাসা খোঁজা এখন আরো সহজ,<br /> <span class="text-purple-600">'বাসা লাগবে'</span> এর সাথে !</h1>

                    <p class="sm:w-[70%] text-lg font-bold mb-10">
